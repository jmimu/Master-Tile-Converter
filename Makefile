...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Sat May 19 08:40:57 2012
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/sms_3bpp_tiles_reader1.0.0/ && $(COPY_FILE) --parents mainwindow.h tile.h palette.h tileswidget.h palettewidget.h zoomwidget.h rom.h romheader.h .tmp/sms_3bpp_tiles_reader1.0.0/ && $(COPY_FILE) --parents data.qrc .tmp/sms_3bpp_tiles_reader1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp tile.cpp palette.cpp tileswidget.cpp palettewidget.cpp zoomwidget.cpp rom.cpp romheader.cpp .tmp/sms_3bpp_tiles_reader1.0.0/ && $(COPY_FILE) --parents mainwindow.ui .tmp/sms_3bpp_tiles_reader1.0.0/ && (cd `dirname .tmp/sms_3bpp_tiles_reader1.0.0` && $(TAR) sms_3bpp_tiles_reader1.0.0.tar sms_3bpp_tiles_reader1.0.0 && $(COMPRESS) sms_3bpp_tiles_reader1.0.0.tar) && $(MOVE) `dirname .tmp/sms_3bpp_tiles_reader1.0.0`/sms_3bpp_tiles_reader1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/sms_3bpp_tiles_reader1.0.0
