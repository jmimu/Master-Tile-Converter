...
# Generated by qmake (2.01a) (Qt 4.6.3) on: Tue Nov 27 15:12:28 2012
...
SOURCES       = main.cpp \
		...
		rom.cpp \
		romheader.cpp \
		dialog_about.cpp moc_mainwindow.cpp \
		moc_tileswidget.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/mastertileconverter1.0.0/ && $(COPY_FILE) --parents mainwindow.h tile.h palette.h tileswidget.h palettewidget.h zoomwidget.h rom.h romheader.h dialog_about.h .tmp/mastertileconverter1.0.0/ && $(COPY_FILE) --parents data.qrc .tmp/mastertileconverter1.0.0/ && $(COPY_FILE) --parents main.cpp mainwindow.cpp tile.cpp palette.cpp tileswidget.cpp palettewidget.cpp zoomwidget.cpp rom.cpp romheader.cpp dialog_about.cpp .tmp/mastertileconverter1.0.0/ && $(COPY_FILE) --parents mainwindow.ui dialog_about.ui .tmp/mastertileconverter1.0.0/ && (cd `dirname .tmp/mastertileconverter1.0.0` && $(TAR) mastertileconverter1.0.0.tar mastertileconverter1.0.0 && $(COMPRESS) mastertileconverter1.0.0.tar) && $(MOVE) `dirname .tmp/mastertileconverter1.0.0`/mastertileconverter1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/mastertileconverter1.0.0
